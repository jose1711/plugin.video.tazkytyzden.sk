...
__scriptid__ = 'plugin.video.tazkytyzden.sk'
__scriptname__ = 'tazkytyzden.sk'
...
class TazkytyzdenXBMCContentProvider(xbmcprovider.XBMCMultiResolverContentProvider):
    def play(self, item):
...
TazkytyzdenXBMCContentProvider(tazkytyzden.TazkytyzdenContentProvider(tmp_dir=xbmc.translatePath(__addon__.getAddonInfo('profile'))), settings, __addon__).run(params)
